...
const SERVICES: ServiceConfig[] = [
  ...
  { name: 'production', localPort: 3009, role: 'Creative — Orchestration', expected: 'running' },
  ...
  { name: 'loom', localPort: 3038, role: 'The Loom — Model Serving', expected: 'running' },
  ...
  { name: 'azioncall', localPort: 3009, role: 'The Voice Brain', expected: 'running' },
  ...
  { name: 'ear', localPort: 3009, role: 'The Ear', expected: 'shared-port' },
